 ...
 */
@WebServlet(name = "busquedaPedidoIngresado", description = "Principal de pedidos", urlPatterns = { "/busquedaPedidoV" })
public class busquedaPedidoV extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		if (usuario != null) {
			...
			List<COrder> co = cox.buscarTodosEnSaramPrePedidos(ad);
...
//			out.println("</div>");
			out.println("<div class=\"toolbar\">");
			out.println("<a href=\"pedido?ad_user_id="+ usuario +"\" class=blueButtonRegresar>Regresar</a><h1 id=\"pageTitle\">Por Facturar</h1>");
			out.println("</div>");
			out.close();
		}
	}
