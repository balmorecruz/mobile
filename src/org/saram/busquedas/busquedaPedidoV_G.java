 ...
 */
@WebServlet(name = "busquedaPedidoIngresadoV_G", description = "Principal de pedidos", urlPatterns = { "/busquedaPedidoV_G" })
public class busquedaPedidoV_G extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		if (usuario != null) {
			...
			List<COrder> co = cox.buscarConFacturas(ad);
			//List<COrder> s=cox.buscarConFacturas(ad);
//			for (int i = 0; i < s.size(); i++) {
//				System.out.println("ID C_ORDER:::::::"+s.get(i).getC_order_id());
//			}
...
//					ci = cix.buscarFacturadoPorOrden(coi.getC_order_id());
					...
					out.println("<li>");
					out.println("<a href=\"busquedaProformaf?ad_user_id=" + ad.getAd_user_id() + "&c_bpartner_id="
...
//			out.println("</div>");
			out.println("<div class=\"toolbar\">");
			out.println("<a href=\"pedido?ad_user_id="+ usuario +"\" class=blueButtonRegresar>Regresar</a><h1 id=\"pageTitle\">Facturado</h1>");
			out.println("</div>");
			out.close();
		}
	}
