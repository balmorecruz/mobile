...
//				}
				coi.setQtyreserved(Float.parseFloat("0.0"));
				coi.setProcessed("Y");
				cp.salvarOrden(coi);
			}
...
//							 enviarCorreos(mensaje,"conavigan@gmail.com","julissa.menjivar@mor.com.sv","ventasconavigan@gmail.com","","");
						} else {
							enviarCorreos(mensaje, "pedidos@mor.com.sv", "notificaciones.informatica@mor.com.sv", "",
									"", email);
...
////			mensaje.addRecipient(Message.RecipientType.CC, new InternetAddress("jefecreditos.saram@gmail.com"));
...
//		propiedades.put("mail.smtp.starttls.enable", "true");
		...
		try {
			...
			mensaje.addRecipient(Message.RecipientType.TO, new InternetAddress("<" + para + ">"));
			mensaje.addRecipient(Message.RecipientType.CC, new InternetAddress("<" + copia1 + ">"));
			mensaje.addRecipient(Message.RecipientType.CC, new InternetAddress("<" + "analistadesistemas@mor.com.sv" + ">"));
			...
			// mensaje.addRecipient(Message.RecipientType.CC, new
			// InternetAddress("jefecreditos.saram@gmail.com"));
			// mensaje.addRecipient(Message.RecipientType.CC, new
