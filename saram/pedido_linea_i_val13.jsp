...
<%!private void precioProducto(javax.servlet.jsp.JspWriter out, String cb, String mp) {
	System.out.println("HOLAAAA ival13");	
	try {
...
<%
	precioProducto(out, request.getParameter("c_bpartner_id"), request.getParameter("m_product_id"));
%>
<body>
